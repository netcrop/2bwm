...
static const char *verifycmd[] = { "/usr/local/bin/2bwm.verify", NULL };
static const char *verify1cmd[] = { "/usr/local/bin/2bwm.verify1", NULL };
static const char *verify2cmd[] = { "/usr/local/bin/2bwm.verify2", NULL };
static const char *verify3cmd[] = { "/usr/local/bin/2bwm.verify3", NULL };
static const char *verify4cmd[] = { "/usr/local/bin/2bwm.verify4", NULL };
static const char *verify5cmd[] = { "/usr/local/bin/2bwm.verify5", NULL };
static const char *verify6cmd[] = { "/usr/local/bin/2bwm.verify6", NULL };
...
// Verify programs
{  ALT,               XK_0,          start,             {.com = verifycmd}},
{  ALT,               XK_1,          start,             {.com = verify1cmd}},
{  ALT,               XK_2,          start,             {.com = verify2cmd}},
{  ALT,               XK_3,          start,             {.com = verify3cmd}},
{  ALT,               XK_4,          start,             {.com = verify4cmd}},
{  ALT,               XK_5,          start,             {.com = verify5cmd}},
{  ALT,               XK_6,          start,             {.com = verify6cmd}},
